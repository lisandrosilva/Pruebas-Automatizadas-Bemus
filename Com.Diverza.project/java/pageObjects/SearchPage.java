...
public class SearchPage {
	...
	public WebDriver driver;
        ...
        By Moneda = By.cssSelector("[data-id='receipt_currency']");
        
        By HotP = By.id("hotp-request-input");
        
        By ConfirmationCode = By.cssSelector("[href='#modal-hotp-confirmation-code']");
        ...
        By GenerarCodigo = By.xpath("/html/body/div[1]/div/div/div[3]/button[2]");
